 ...
 */
export const APP_NAME: string = "Crypto Canon";

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = "The Crypto Canon in a mini-app";
 ...
 */
export const APP_TAGS: string[] = ["bitcoin", "education", "reading"];
...
export const APP_ACCOUNT_ASSOCIATION: AccountAssociation | undefined = {
  header: "eyJmaWQiOjQ0NjY5NywidHlwZSI6ImN1c3RvZHkiLCJrZXkiOiIweDgyYTY4YzM5NWM4MzVlNzJiMDYzMTFhRTY3ZjVBRjA3ZkI2YzQ2NTgifQ",
  payload: "eyJkb21haW4iOiJjcnlwdG9jYW5vbi54eXoifQ",
  signature: "JSvHcTPtE7+WJtVb9LBEXtVpBfeeYCAFoSV5xn1SYKQ419Bv4NGkKMKc6/jMu0j2pELOvpdXXgTsjNzt4ob/lxs="
};
 ...
 */
export const APP_BUTTON_TEXT: string = "Read";
